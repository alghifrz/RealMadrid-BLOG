<x-templateview></x-templateview>

            {{-- postingan --}}
            <div class="mt-24 mx-24">
                <h3 class="text-4xl font-bold mb-12 border-b-2 border-gray-200 pb-6">All Posts</h3>
                ...
                <x-listview img="https://publish-p47754-e237306.adobeaemcloud.com/adobe/dynamicmedia/deliver/dm-aid--9e6a6bf5-56d2-4072-a3f3-ce38c2f2a073/ND_MBAPPE_MJ23208.app.webp?preferwebp=true&width=1440" comp="Medical Report" title="Laporan medis Mbappe" detail="Setelah menjalani tes terhadap Kylian Mbappé hari ini oleh departemen medis Real Madrid, pemain tersebut didiagnosis mengalami cedera paha di kaki kirinya. Perkembangannya akan dipantau."/>
                ...
                <div class="flex justify-center gap-8 mt-24">
                    <a href="/blog" class="font-bold text-2xl text-black hover:text-biru">< Prev</a>
                    <a href="#" class="font-bold text-2xl text-gray-500">Next ></a>
                </div>
            </div>

<x-templateview-bot></x-templateview-bot>