<nav class="bg-white shadow-sm py-2 fixed w-full top-0 z-40" x-data="{ isOpen: false }">
        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4 justify-end">
              ...
              <a href="/blog" class="px-3 py-2 text-lg font-semibold {{ request()->is('blog') || request()->is('blog2') || request()->is('blogpost') ? 'text-biru border-b-2 border-biru' : 'text-abu hover:text-biru' }}">Blog</a>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/blog" class="block rounded-md px-3 py-2 text-base font-semibold {{ request()->is('blog') ? 'text-biru' : 'text-abu hover:text-biru' }}">Blog</a>
        <a href="/about" class="block rounded-md px-3 py-2 text-base font-semibold {{ request()->is('about') ? 'text-biru' : 'text-abu hover:text-biru' }}">About Us</a>
