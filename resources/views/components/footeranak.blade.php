<div class="mt-32 bg-gelap z-40 py-10" x-data="{ isOpen: false }">
        ...
        <div class="flex items-center">
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-10 justify-end">
              ...
              <a href="/blog" class="rounded-md py-2 text-lg font-medium {{ request()->is('blog') || request()->is('blog2') || request()->is('blogpost') || request()->is('blog/*') ? 'text-white' : 'text-white hover:text-gray-200' }}">Blog</a>
              ...
              <a href="/privacy" class="rounded-md py-2 text-lg font-medium {{ request()->is('privacy') ? 'text-white' : 'text-white hover:text-gray-200' }}">Privacy Policy</a>
            </div>
          </div>
        </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-0 py-3 sm:px-3">
        ...
        <a href="/blog" class="block rounded-md px-3 py-2 text-base font-semibold {{ request()->is('blog') ? 'text-white' : 'text-white hover:bg-gray-200 hover:text-gelap' }}">Blog</a>
        ...
        <a href="/privacy" class="block rounded-md px-3 py-2 text-base font-semibold {{ request()->is('privacy') ? 'text-white' : 'text-white hover:bg-gray-200 hover:text-gelap' }}">Privacy Policy</a>
      </div>
    </div>
